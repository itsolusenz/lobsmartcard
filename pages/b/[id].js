                                        ...
                                        <div className="card-body position-relative">
                                            <div className="d-flex flex-column align-items-center text-center">
                                                ...
                                                <div className=" profile-name-container">
                                                    ...
                                                    <p className="text-secondary">{Profilelist[0].flat}, {Profilelist[0].street}<br />{Profilelist[0].landmark}</p>
                                                    <p className="text-secondary">{Profilelist[0].street}, {Profilelist[0].city} - {Profilelist[0].postcode}</p>

                                                    <div className='d-flex justify-content-center'>
                                                        {Profilelist[0].fb != "" &&
                                                            <a href={Profilelist[0].fb}><span className='social-btn me-2'><i class="bi bi-facebook"></i></span></a>
                                                        }
                                                        {Profilelist[0].twitter != "" &&
                                                            <a href={Profilelist[0].twitter}><span className='social-btn me-2'><i class="bi bi-twitter"></i></span></a>
                                                        }
                                                        {Profilelist[0].youtube != "" &&
                                                            <a href={Profilelist[0].youtube}><span className='social-btn me-2'><i class="bi bi-browser-chrome"></i></span></a>
                                                        }
                                                        {Profilelist[0].linkedin != "" &&
                                                            <a href={Profilelist[0].linkedin}><span className='social-btn me-2'><i class="bi bi-linkedin"></i></span></a>
                                                        }
