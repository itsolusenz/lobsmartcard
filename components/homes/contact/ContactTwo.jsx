    ...
    <div className="LobSmartCard-page-area z-index-3">
      <div className="container">
        <div className="LobSmartCard-page-wrap pt-60 pl-80 pr-80">
          ...
          <div className="LobSmartCard-contact-2-wrap">
            <div className="row">
              <div className="col-xl-4 col-lg-12">
                <div className="LobSmartCard-contact-2-item-wrap mb-60">
                  <div className="row">
                    {contactItems.map((elm, i) => (
                      <div key={i} className="col-xl-12 col-lg-6">
                        <div
                          className={`LobSmartCard-contact-item  ${elm.bgColor} bg-prink mb-30`}
                        >
                          <div className="icon">
                            <Image
                              width={40}
