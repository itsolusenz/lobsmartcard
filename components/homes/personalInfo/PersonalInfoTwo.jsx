...
export default function PersonalInfoTwo() {
  return (
    <div className="col-12">
      <div className="LobSmartCard-parsonal-info-area LobSmartCard-parsonal-info-2-area">
        <div className="LobSmartCard-parsonal-info-wrap">
          ...
          <span className="LobSmartCard-parsonal-info-bio mb-15">{profileInfo.title}</span>
