...
export default function AboutTwo() {
  ...
  return (
    <div className="LobSmartCard-page-wrap pt-60 pl-80 pr-80">
      <div className="page-tilte-2-wrap">
        <div className="row">
          <div className="col-12">
            <div className="LobSmartCard-page-title-wrap mb-40">
      ...
      <div className="about-me-2-wrap">
        <div className="row">
          ...
          <div className="col-lg-8 col-md-12">
            <div className="LobSmartCard-parsonal-info-wrap mb-40">
              <h4 className="LobSmartCard-parsonal-info-title">Who am i?</h4>
              <p className="LobSmartCard-parsonal-info-bio-text">{bioData.descOne}</p>

              <p className="LobSmartCard-parsonal-info-bio-text">{bioData.descTwo}</p>
      ...
      <div className="client-2-wrap bg-light-white-2 pt-40 pb-65">
        <div className="row">
          <div className="col-12">
            <div className="LobSmartCard-section-title-wrap text-center mb-35">
