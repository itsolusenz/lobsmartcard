            ...
            <section className="card__details__section pt-120 pb-120 bgadd ralt">
                <div className="container">
                    <div style={{ color: 'black' }}>
                        <p className='ptext2 fz-16 fw-400 inter wow fadeInDown' style={{ TextAlign: "justify" }}>   <span style={{ display: 'flex' }}><h6 className="sub ralt base mb-16 wow fadeInUp">  Effective Date:</h6>&nbsp; <b>01-Apr-2023</b></span>
                            ...
                            <h4 className="title mb-24 wow fadeInUp"><b>Interpretation and Definitions</b></h4>
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Interpretation </h4>
                            The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.


                            <h4 className="sub ralt base mb-16 wow fadeInUp">Definitions </h4>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Collecting and Using Your Personal Data </h4>
                            <h6 className="sub ralt base mb-16 wow fadeInUp">Types of Data Collected </h6>
                            <h7 className="sub ralt base mb-16 wow fadeInUp">Personal Data </h7>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Tracking Technologies and Cookies </h4>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Use of Your Personal Data </h4>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Retention of Your Personal Data </h4>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Transfer of Your Personal Data </h4>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Delete Your Personal Data </h4>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Disclosure of Your Personal Data</h4>
                            <h6 className="sub ralt base mb-16 wow fadeInUp">Business Transactions </h6>
                            If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.


                            <h6 className="sub ralt base mb-16 wow fadeInUp">Law enforcement </h6>
                            Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).


                            <h6 className="sub ralt base mb-16 wow fadeInUp">Other legal requirements</h6>
                            ...
                            <h6 className="sub ralt base mb-16 wow fadeInUp">Security of Your Personal Data </h6>
                            The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.


                            <h6 className="sub ralt base mb-16 wow fadeInUp">Children's Privacy </h6>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Links to Other Websites </h4>
                            Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.

                            We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.


                            <h4 className="sub ralt base mb-16 wow fadeInUp">Changes to this Privacy Policy </h4>
                            ...
                            <h4 className="sub ralt base mb-16 wow fadeInUp">Contact Us</h4>
