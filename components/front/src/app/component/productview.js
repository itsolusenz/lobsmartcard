...
export default function Productview(props) {
    ...
    useEffect(() => {
        ...
        const getProfile = async (a, b) => {
            ...
            const response = await fetch('https://www.laabamone.com/Lobsmart/api.php?eventtype=lob_Getproduct&profileid=' + a + '&productid=' + b);
            const json = await response.json();
            console.log(json);
            setproddata(json);
    ...
    const SaveProduct = () => {
        ...
        if (error == 1) {
            ...
            console.log('https://www.laabamone.com/Lobsmart/api.php?eventtype=lob_addprofile&type=addproduct'
                + str + '&profileid=' + cusid + '&name=' + pname +
                '&message=' + pdescription +
                '&link=' + plink)
            fetch('https://www.laabamone.com/Lobsmart/api.php?eventtype=lob_addprofile&type=addproduct'
                + str + '&profileid=' + cusid + '&name=' + pname +
                '&message=' + pdescription +
                '&link=' + plink
            )
            ...
            <Box fullWidth sx={{ padding: '20px', borderRadius: '6px', border: '1px solid #557191' }}>
                ...
                <div className="row col-md-12" >
                    <div className="col-md-12 " >
                        <h5 className="title addi__head round16">Products:</h5>
                    </div>
                    ...
                    <div className="col-md-12 " style={{ paddingTop: '10px' }}>
                        <h5 className="title addi__head round16">Product Image:</h5>
                    </div>
                    <div className="row col-md-12" >
